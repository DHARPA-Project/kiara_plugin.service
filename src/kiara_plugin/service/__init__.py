...
"""Top-level package for kiara_plugin.service."""
...
KIARA_METADATA = {
    ...
    "description": "Kiara modules for: service",
    "references": {
        "source_repo": {
            "desc": "The module package git repository.",
            "url": "https://github.com/DHARPA-Project/kiara_plugin.service",
        },
        "documentation": {
            "desc": "The url for the module package documentation.",
            "url": "https://DHARPA-Project.github.io/kiara_plugin.service/",
        },
    },
    "tags": ["service"],
...
find_modules: KiaraEntryPointItem = (
    find_kiara_modules_under,
    "kiara_plugin.service.modules",
)
find_model_classes: KiaraEntryPointItem = (
    find_kiara_model_classes_under,
    "kiara_plugin.service.models",
)
find_data_types: KiaraEntryPointItem = (
    find_data_types_under,
    "kiara_plugin.service.data_types",
)
find_pipelines: KiaraEntryPointItem = (
    find_pipeline_base_path_for_module,
    "kiara_plugin.service.pipelines",
    KIARA_METADATA,
)
